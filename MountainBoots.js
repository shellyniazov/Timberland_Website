...
window.onload = function () {
	...
	JSON.parse(localStorage.getItem('itemsZ')).map(data => {
		tableDataZ += '<h6>' + data.idZ + '</h6><h5>' + data.nameZ  + '</h5><h5>'  + ' ' + data.priceZ + '</h5><h5>' + '<a href="#" <i class="far fa-trash-alt" onclick=DeleteZX(this);></i></a></h5>' + '_________________________';
	});
...
iconShoppingP.innerHTML = no1; // innerHTML -> הדפסה לאתר
